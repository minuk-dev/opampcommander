...
var _ port.OrgRoleMappingUsecase = (*OrgRoleMappingService)(nil)
...
type OrgRoleMappingService struct {
	orgRoleMappingPersistencePort port.OrgRoleMappingPersistencePort
...
// GetOrgRoleMapping implements [port.OrgRoleMappingUsecase].
...
// ListOrgRoleMappings implements [port.OrgRoleMappingUsecase].
...
// ListOrgRoleMappingsByProvider implements [port.OrgRoleMappingUsecase].
...
// SaveOrgRoleMapping implements [port.OrgRoleMappingUsecase].
...
// DeleteOrgRoleMapping implements [port.OrgRoleMappingUsecase].
...
func (s *OrgRoleMappingService) ResolveRolesForIdentity(
	...
	roles := make([]*model.Role, 0, len(roleIDSet))
