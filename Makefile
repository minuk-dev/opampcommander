...
bench-liveness:
	...
	go test ./pkg/apiserver/domain/agent/service -run XXX -bench BenchmarkHeartbeatWriteCost -benchtime 2000x
...
docker-image:
	...
	@echo ""
	@echo "docker push ghcr.io/minuk-dev/opampcommander:$(TAG)-amd64"
	@echo "docker push ghcr.io/minuk-dev/opampcommander:$(TAG)-arm64"
	@echo ""
	@echo "To create and push the manifest:"
	@echo ""
	@echo "docker manifest create ghcr.io/minuk-dev/opampcommander:$(TAG) \\"
	@echo "  ghcr.io/minuk-dev/opampcommander:$(TAG)-amd64 \\"
	@echo "  ghcr.io/minuk-dev/opampcommander:$(TAG)-arm64"
	@echo ""
	@echo "docker manifest push ghcr.io/minuk-dev/opampcommander:$(TAG)" 
