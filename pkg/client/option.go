...
// the collection on every request; the page limit does not bound it. Prefer
// WithName where a prefix will do, and pass both to bound the scan to that
// prefix's indexed range.
