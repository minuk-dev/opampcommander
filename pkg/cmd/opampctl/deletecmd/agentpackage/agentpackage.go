...
func (o *CommandOptions) Run(cmd *cobra.Command, names []string) error {
	...
	results := lo.Map(names, func(name string, _ int) deleteResult {
		return deleteResult{
			name: name,
			err:  o.client.AgentPackageService.DeleteAgentPackage(cmd.Context(), o.namespace, name),
		}
	})
...
func (o *CommandOptions) ValidArgsFunction(
	...
	agentPackages, err := clientutil.ListAgentPackageFully(cmd.Context(), client, o.namespace)
	if err != nil {
		return nil, cobra.ShellCompDirectiveError
	}
