...
// ParseSemantic parses a semantic version string and returns a Version object.
// It's from https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s.io/component-base/version/dynamic.go
func ParseSemantic(str string) (*Version, error) {
	return parse(str, true)
}

//nolint:cyclop,err113,varnamelen,noinlineerr,exhaustruct
func parse(str string, semver bool) (*Version, error) {
	...
	for i, comp := range components {
		...
		if err != nil {
			return nil, fmt.Errorf("illegal non-numeric version component %q in %q: %w", comp, str, err)
		}
