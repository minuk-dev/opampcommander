...
type ListOptions struct {
	...
	// this is a scan of the collection on every request — combine it with
	// NamePrefix to bound that. See [model.ListOptions] for the full cost and for
	// why it is a separate option rather than a mode of NamePrefix.
	NameContains string
