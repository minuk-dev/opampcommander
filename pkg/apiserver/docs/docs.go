...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/namespaces/{namespace}/agentgroups/{name}": {
            "get": {
        ...
        "/api/v1/namespaces/{namespace}/agentpackages/{name}": {
            "get": {
        ...
        "/api/v1/namespaces/{namespace}/agents": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Case-insensitive UID substring (scan; pass name= to bound it)",
                        "name": "nameContains",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/namespaces/{namespace}/rolebindings/{name}": {
            "get": {
        ...
        "/api/v1/roles": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Case-insensitive display-name substring (scan; pass name= to bound)",
                        "name": "nameContains",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "AgentGroupSpec": {
            ...
            "properties": {
                "agentConfig": {
                    "$ref": "#/definitions/github_com_minuk-dev_opampcommander_api_v1.AgentConfig"
                },
                "priority": {
                    "type": "integer"
                },
                "selector": {
                    "$ref": "#/definitions/github_com_minuk-dev_opampcommander_api_v1.AgentSelector"
                }
            }
        },
        "AgentGroupStatus": {
        ...
        "CertificateMetadata": {
            ...
            "properties": {
                ...
                "namespace": {
                    "description": "Namespace is the namespace the certificate belongs to.",
                    "type": "string"
                }
            }
        },
        ...
        "RoleBinding": {
            ...
            "properties": {
                ...
                "metadata": {
                    "description": "Metadata contains the metadata of the role binding.",
                    "allOf": [
                        {
                ...
                "spec": {
                    "description": "Spec contains the specification of the role binding.",
                    "allOf": [
                        {
                ...
                "status": {
                    "description": "Status contains the status of the role binding.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/RoleBindingStatus"
                        }
                    ]
                }
            }
        ...
        "RoleBindingMetadata": {
            ...
            "properties": {
                ...
                "deletedAt": {
                    "description": "DeletedAt is the timestamp when the role binding was soft deleted.",
                    "type": "string"
                },
                "name": {
                    "description": "Name is the unique name of the role binding within the namespace.",
                    "type": "string"
                },
                "namespace": {
                    "description": "Namespace is the namespace scope for this role binding.",
                    "type": "string"
                },
                "updatedAt": {
        ...
        "RoleBindingRoleRef": {
            ...
            "properties": {
                "kind": {
                    "description": "Kind is the type of the referenced resource (e.g., \"Role\").",
                    "type": "string"
                },
                "name": {
        ...
        "RoleBindingStatus": {
            ...
            "properties": {
                "conditions": {
                    "description": "Conditions contains the conditions of the role binding.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/Condition"
                    }
