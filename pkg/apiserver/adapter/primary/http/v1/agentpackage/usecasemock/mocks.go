...
func (_c *MockUsecase_CreateAgentPackage_Call) Return(agentPackage1 *v1.AgentPackage, err error) *MockUsecase_CreateAgentPackage_Call {
...
func (_mock *MockUsecase) ListAgentPackages(ctx context.Context, namespace string, options *port.ListOptions) (*v1.ListResponse[v1.AgentPackage], error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, *port.ListOptions) (*v1.ListResponse[v1.AgentPackage], error)); ok {
		return returnFunc(ctx, namespace, options)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, *port.ListOptions) *v1.ListResponse[v1.AgentPackage]); ok {
...
func (_e *MockUsecase_Expecter) ListAgentPackages(ctx interface{}, namespace interface{}, options interface{}) *MockUsecase_ListAgentPackages_Call {
	return &MockUsecase_ListAgentPackages_Call{Call: _e.mock.On("ListAgentPackages", ctx, namespace, options)}
}

func (_c *MockUsecase_ListAgentPackages_Call) Run(run func(ctx context.Context, namespace string, options *port.ListOptions)) *MockUsecase_ListAgentPackages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockUsecase_ListAgentPackages_Call) Return(listResponse *v1.ListResponse[v1.AgentPackage], err error) *MockUsecase_ListAgentPackages_Call {
