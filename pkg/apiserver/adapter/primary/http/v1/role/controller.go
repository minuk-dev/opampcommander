...
// @Param nameContains query string false "Case-insensitive display-name substring (scan; pass name= to bound)"
...
func (c *Controller) List(ctx *gin.Context) {
	...
	selectors, ok := ginutil.ParseSelectors(ctx, ginutil.NoMetadataSelector, applicationport.RoleSelectableFields)
	if !ok {
		return
	}
