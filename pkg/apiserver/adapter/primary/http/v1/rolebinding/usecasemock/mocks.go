...
func (_mock *MockUsecase) ListRoleBindings(ctx context.Context, namespace string, options *port.ListOptions) (*v1.ListResponse[v1.RoleBinding], error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, *port.ListOptions) (*v1.ListResponse[v1.RoleBinding], error)); ok {
		return returnFunc(ctx, namespace, options)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, *port.ListOptions) *v1.ListResponse[v1.RoleBinding]); ok {
...
func (_e *MockUsecase_Expecter) ListRoleBindings(ctx interface{}, namespace interface{}, options interface{}) *MockUsecase_ListRoleBindings_Call {
	return &MockUsecase_ListRoleBindings_Call{Call: _e.mock.On("ListRoleBindings", ctx, namespace, options)}
}

func (_c *MockUsecase_ListRoleBindings_Call) Run(run func(ctx context.Context, namespace string, options *port.ListOptions)) *MockUsecase_ListRoleBindings_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockUsecase_ListRoleBindings_Call) RunAndReturn(run func(ctx context.Context, namespace string, options *port.ListOptions) (*v1.ListResponse[v1.RoleBinding], error)) *MockUsecase_ListRoleBindings_Call {
	_c.Call.Return(run)
	return _c
}
