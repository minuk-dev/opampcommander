...
// Config holds the settings for observability features. It is owned by the
// observability package so callers do not depend on the aggregate config package;
// the config package composes this into its management settings.
type Config struct {
