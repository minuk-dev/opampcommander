...
function AgentsInner() {
  ...
  return (
    <div>
      ...
      {/* Description search filters the fetched page rather than the query, so the
          server's total counts a different set than the rows above. The footer
          reports what it can actually know instead. */}
      <PaginationFooter
        pagination={pagination}
        clientFilteredCount={descParam ? visibleAgents.length : undefined}
      />
